...
//fonction pour encrypter le password côté client
function encrypte() {
    //si le champs password est vide on encode pas - important pour la validation php
    if (document.loginForm.password.value.trim() == "") {
        document.formEncrypte.password.value = "";
    }
    else {
